...
- 审批链模板
  参考: 当前仓库本地 fixture `human-input-approval-workflow.yml`

- Webhook 触发模板
  参考: 当前仓库本地 fixture `trigger-webhook-code-workflow.yml`

- 定时任务模板
  参考: 当前仓库本地 fixture `trigger-schedule-http-workflow.yml`

### 已由模板结构间接支撑

- RAG 问答模板
  说明:
  当前仓库中已经存在非常接近的本地 fixture `knowledge-retrieval-chatflow.yml`，但仍不是与外部样例索引同名的一比一来源，所以维持“间接支撑”而不是“直接支撑”。
