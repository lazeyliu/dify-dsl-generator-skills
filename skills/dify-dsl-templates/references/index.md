...
只有当任务明确要求“从模板起手”“挑模板”“选模板变体”或“基于模板重排”时，才进入这个目录；如果只是修一个已有 DSL，优先回到 [../../dify-dsl-foundations/references/task-routing.md](../../dify-dsl-foundations/references/task-routing.md) 走修复路线。
